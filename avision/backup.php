	...
	<div class="home">
		...
		<div class="home_slider_container">
			<div class="owl-carousel owl-theme home_slider">
				...
				<!-- Slider Item -->
				<div class="owl-item">
					<div class="home_slider_background"><?php echo '<img style="position: absolute;top: 0;left: 0;width: 100%;height: 100%;background-repeat: no-repeat;	background-size: cover;	background-position: center center;" src="data:image/jpeg;base64,'.base64_encode( $data['image'] ).'"/>';?></div>
					<div class="home_slider_content_container">
						<div class="container">
							<div class="row">
								<div class="col">
